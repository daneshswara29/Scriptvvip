...
echo -e "     ${BICyan}[${BIWhite}11${BICyan}] Check Log Create"
echo -e "     ${BICyan}[${BIWhite}12${BICyan}] Instalasi UDPGW Mini"
...
9) clear ; bw ; exit ;;
10) clear ; jam ; exit ;;
11) clear ; cat /etc/log-create-user.log ; exit ;;
12) clear ;
echo -e "PROSES INSTALASI UDPGW MINI 7100, 7200, 7300"; sleep 5;

mkdir -p /usr/local/kyt/
wget -q -O /usr/local/kyt/udp-mini "https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/udpcustom/udp-mini"
chmod +x /usr/local/kyt/udp-mini
wget -q -O /etc/systemd/system/udp-mini-1.service "https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/udpcustom/udp-mini-1.service"
wget -q -O /etc/systemd/system/udp-mini-2.service "https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/udpcustom/udp-mini-2.service"
wget -q -O /etc/systemd/system/udp-mini-3.service "https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/udpcustom/udp-mini-3.service"
