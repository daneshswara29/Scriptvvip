...
export sem=$( curl -s https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/versions)
...
echo -e "${BICyan} │  ${BICyan}REBOOT    :  ${BIYellow}04:00 ( Jam 04 SUBUH )${NC}"
echo -e "${BICyan} │  ${BICyan}WHATSAP   :  ${BIYellow}082380835972${NC}"
echo -e "${BICyan} │  ${BICyan}DEVELOVER :  ${BIYellow}🇮🇩 DANESHSWARA 🇮🇩${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}" 
