#!/bin/bash
BURIQ () {
curl -sS https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/register > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/register | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/register | awk '{print $4}' | grep $MYIP)
if [ "$MYIP" = "$IZIN" ]; then
Bloman
else
...
Exp=$(curl -sS https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/register | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/daneshswara29/Scriptvvip/main/version)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "$(figlet " DANESHSWARA")" | lolcat
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}DANESHSWARA${NC}"
echo -e "${BICyan} │"
...
echo -e "${BICyan} │  ${BICyan}DEVELOPER :  ${BIYellow}DANESHSWARA࿐${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
echo -e "${BICyan}    │$NC ${GREEN}Username        :\033[1;36m $Name \e[0m"
if [ $exp \< 1000 ];
then
echo -e "${BICyan}    │$NC License Script  : ${GREEN}$sisa_hari$NC Days Tersisa $NC"
else
datediff "$Exp" "$DATE"
fi;
echo -e "${BICyan}    └───────────────────────────────────────────────┘${NC}"
